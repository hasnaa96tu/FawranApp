        ...
        <div class="card ">
          ...
          <div class="card-body ">
            <form class="form-horizontal">
              ...
              <div class="row">
                <label class="col-md-3 col-form-label">Rest name</label>
                <div class="col-md-9">
      ...
      <div class="col-md-6">
        <div class="card ">
          ...
          <div class="card-body ">
              ...
              <div class="row">
                <label class="col-md-3 col-form-label">meals number</label>
                <div class="col-md-9">
                  <div class="form-group has-default">
                    <input type="number" class="form-control">
                  </div>
              ...
              <div class="row">
                <label class="col-md-3 col-form-label">weekend day</label>
                <div class="col-md-9">
                  <div class="form-group has-default">
                    <input type="text" class="form-control">
                  </div>
