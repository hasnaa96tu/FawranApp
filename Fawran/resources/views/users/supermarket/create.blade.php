            ...
            <div class="col-md-7">
                <div class="card ">
                    <div class="card-header card-header-rose card-header-icon">
                        ...
                        <h4 class="card-title">Add Supermarket</h4>
                    </div>
                    <div class="card-body ">
                        <form method="POST" action="{{route('supermarket.store')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group has-default">
                                        <input type="hidden" class="form-control" name="category_id" value="2">
                                        <input type="hidden" class="form-control" name="type_id" value="2">
