            ...
            <div class="col-md-7">
                ...
                {{ csrf_field() }}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group has-default">
                                        <input type="text" class="form-control" name="name_ar" value="{{$pharmacy->name_ar}}">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group has-default">
                                    <input type="text" class="form-control" name="location" value="{{$pharmacy->location}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group has-default">
                                    <input type="text" class="form-control" name="location_ar" value="{{$pharmacy->location_ar}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group has-default">
                                    <input type="time" class="form-control" name="open_time" value="{{$pharmacy->available_times->first()->open_time}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <div class="form-group has-default">
                                    <input type="time" class="form-control" name="close_time" value="{{$pharmacy->available_times->first()->close_time}}">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-9">
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        ...
                                        <img src="/assets/img/{{$pharmacy->image}}" alt="...">
                                    </div>
